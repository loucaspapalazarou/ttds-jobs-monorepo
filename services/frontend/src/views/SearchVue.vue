...
<template>
    <div class="flex flex-col gap-3 w-full mt-5">
        <!--        &lt;!&ndash; Download button at the top &ndash;&gt;-->
        <!--        <div class="flex justify-between mt-4">-->
        <!--            &lt;!&ndash; Home button &ndash;&gt;-->
        <!--            <router-link to="/" class="bg-blue-500 text-white px-10 py-2 rounded-md self-end"-->
        <!--                         style="font-size: 1.5rem; margin-left: 10px;" title="Go to HomePage">-->
        <!--                <i class="fas fa-home mr-2"></i> Home-->
        <!--            </router-link>-->
        <!--            &lt;!&ndash; Download and feedback buttons &ndash;&gt;-->
        <!--            <div class="flex gap-2">-->
        <!--                &lt;!&ndash; Download button &ndash;&gt;-->
        <!--                <button @click="downloadResults" class="bg-blue-500 text-white px-10 py-2 rounded-md"-->
        <!--                        style="font-size: 1.5rem; margin-right: 10px;" title="Download the Top Results">-->
        <!--                    Download-->
        <!--                </button>-->
        <!--                &lt;!&ndash; Feedback button &ndash;&gt;-->
        <!--                <router-link to="/feedback" class="bg-blue-500 text-white px-10 py-2 rounded-md"-->
        <!--                             style="font-size: 1.5rem; margin-right: 15px;" title="We'd love your feedback">-->
        <!--                    Feedback-->
        <!--                </router-link>-->
        <!--            </div>-->
        <!--        </div>-->
        <div class="min-h-32 pt-12 flex border-b border-slate-100">
        ...
        <div class="flex grow justify-center mb-12">
            ...
            <!-- Loading placeholder -->
            <ul v-else
                class="flex flex-col w-10/12 px-3 divide-y-2 divide-slate-200 dark:divide-slate-600 animate-pulse">
                <li>
                    <search-result placeholder></search-result>
                </li>
                <li>
                    <search-result placeholder class="opacity-75"></search-result>
                </li>
                <li>
                    <search-result placeholder class="opacity-50"></search-result>
                </li>
            </ul>
        </div>
    </div>
